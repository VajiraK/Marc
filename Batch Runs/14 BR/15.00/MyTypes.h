...
#define		MODE_ROBO				4
#define		MODE_BLACK				5
#define		MODE_FREE_COLOR			6
#define		MODE_COLOR				7
#define		MODE_SECURE				8
#define		MODE_DROP_SECURE		9
#define		MODE_DROP_SPACE			10
...
#define		TELE_MAX				30
#define		BKLST_MAX				20//Relate to Bat usage - refer CMyExchange::PickSecured()
...
struct MY_STOCK
{
	MY_PACKS		color;
	MY_PACKS		black;
	MY_PACKS		fcolor;//Free color packs(Exchange fail)
	MY_SC_PACKS		secure;
	MY_ST_MAP		map;
};
struct MY_EX_REC//Use in ReleaseExchange()
{
	MY_CAT_ITEM item[6];
	BYTE		count;
};
